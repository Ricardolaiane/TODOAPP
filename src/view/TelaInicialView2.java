...
public class TelaInicialView2 {
	...
	private void initialize() {
		...
		JLabel jLabelToobarSubtitle = new JLabel("Anote tudo, não perca nada!");
		...
		try {
			...
			if(hasTasks) {
				...
				if (mensagem.isVisible()) {
					//mensagem está visível
					
					//mensagem não está visível e remove mensagem
				...
				if(scrollPane.isVisible()) {
					//scroll não está visível e remove scroll
